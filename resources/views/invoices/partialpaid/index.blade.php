...
@section('mainTitle')
    {{ trans('invoices/invoices.partialpaidinvoices') }}
@endsection

@section('pageTitle1')
    <a href="{{ route('unpaidInvoices') }}">{{ trans('invoices/invoices.partialpaidinvoices') }}</a>
@endsection
    ...
    <div class="row">
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    @include('invoices.partialpaid.table')
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready( function () {
            $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('partialPaidInvoices') }}",
                columns: [
