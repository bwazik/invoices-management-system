...
@section('mainTitle')
    {{ trans('invoices/invoices.unpaidinvoices') }}
@endsection

@section('pageTitle1')
    <a href="{{ route('partialPaidInvoices') }}">{{ trans('invoices/invoices.unpaidinvoices') }}</a>
@endsection
